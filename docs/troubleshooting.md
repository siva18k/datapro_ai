...
**"API offline" in the UI** — API isn't running. `podman compose up api`, or `uvicorn api.main:app --port 8080`, or **Settings → Start API**.
...
**MCP connection refused** — Start MCP: `python mcp_server.py` or `podman compose up datapro-mcp`.
