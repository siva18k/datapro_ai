...
Load it with `python scripts/migrate_finance_data.py --fresh` (see docs/finance-data-guide.md). Point a Postgres dataset in the catalog at schema `finance_data`.
