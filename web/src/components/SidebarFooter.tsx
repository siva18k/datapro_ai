...
export function SidebarFooter({ collapsed = false }: { collapsed?: boolean }) {
  return (
    <div
      className={`sidebar-footer border-t ${
        collapsed
    ...
    >
      {collapsed ? (
        <div className="sidebar-footer-collapsed-stack">
          <a
            href="/about"
            target="_blank"
            rel="noopener noreferrer"
            className="icon-btn sidebar-footer-icon-btn"
            aria-label="About DATA Pro"
            title="About DATA Pro"
          >
            <span className="sidebar-footer-about-mark" aria-hidden>
              ?
            </span>
          </a>
          <NavLink
            to="/settings"
            className={({ isActive }) =>
              `icon-btn sidebar-footer-icon-btn ${isActive ? "icon-btn-active" : ""}`
            }
            aria-label="Settings"
            title="Settings"
          >
          ...
          <ThemeSettings placement="above" compact />
        </div>
      ) : (
        <>
          <a
          ...
          <div className="sidebar-footer-actions flex items-center gap-1">
            <NavLink
              to="/settings"
